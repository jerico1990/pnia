...
<div >
	...
	<div class="col-xs-12 col-sm-7 col-md-1" >
	    <button type="button" class="btn" data-toggle="modal" data-target="#myModal">Consolidado</button>
	    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
		    <div class="modal-header">
		      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		      <h4 class="modal-title" id="myModalLabel">Consolidado por clasificador por monto</h4>
		    </div>
		    <div class="modal-body">
				...
				<?php foreach($consolidados as $consolidado){ ?>
				    <?php $proyecto->total=$consolidado->precio_total+$proyecto->total;?>
				<?php } ?>
				<?php foreach($consolidados as $consolidado){ ?>
				    <tr>
					<td><?= $consolidado->descripcion ?></td>
					<td>
					    <?php if($consolidado->descripcion=="Bienes y Equipos"){ ?>
						25
					    <?php }elseif($consolidado->descripcion=="Divulgación y Comunicaciones"){ ?>
						30
					    <?php }elseif($consolidado->descripcion=="Insumos y Materiales"){ ?>
						15
					    <?php }elseif($consolidado->descripcion=="Pasajes y Viáticos"){ ?>
						25
					    <?php }elseif($consolidado->descripcion=="Personal o servicios"){ ?>
						30
					    <?php } ?>
					</td>
					<td>
				...
				<?php } ?>
				    <tr><td colspan="3"><b>Total</b></td><td class="soles"><b><?= $proyecto->total ?></b></td></tr>
			    </tbody>
			</table>
		    </div>
