  ...
  <section class="block">
	...
	<div class="col-xs-12 col-sm-7 col-md-12"  id="form_act" >
		...
		<?php //if($objetivoespecifico) {?>
		    ...
		    <input type="hidden" value="<?= $actividades2->id?>" id="proyecto-id_actividad_<?= $i; ?>"  />
