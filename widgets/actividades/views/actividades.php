            ...
            <div>
				...
				<?php foreach($actividades as $actividad){?>
					...
					<td>
						...
						<!--<input type="text" id="proyecto-actividades_descripciones_<?= $act ?>" class="form-control" name="Proyecto[actividades_descripciones][]" maxlength="2980" placeholder="Descripción #<?= $act ?>" value="<?= $actividad->descripcion ?>" />-->
						<textarea rows="2" id="proyecto-actividades_descripciones_<?= $act ?>" class="form-control" name="Proyecto[actividades_descripciones][]" maxlength="2980" placeholder="Descripción #<?= $act ?>"><?= $actividad->descripcion ?></textarea>   
					    </div>
					</td>
					<td class="col-xs-2">
				    ...
				    <!--<td>
					    <div>
					    <?php // \app\widgets\fechas\FechasWidget::widget(['actividad_id'=>$actividad->id,'act'=>$act]); ?> 
					    </div>
					</td>-->
					<td>
				...
				<tr id='actividad_addr_1_0'>
					...
					<!--<td>
					    <div>
					    <?php // \app\widgets\fechas\FechasWidget::widget(['actividad_id'=>'','act'=>$act]); ?> 
					    </div>
					</td>-->
				    <td>
					<span class="eliminar glyphicon glyphicon-minus-sign">
 ...
 $("#actividades_tabla").on('click','.eliminar',function(){
    ...
    $("#actividades_row_1").click(function(){
        ...
        for (var i=0; i<cantidadregistros; i++) {
            if(($.trim($('#proyecto-actividades_descripciones_'+(valor[i].value)).val())=='') || ($.trim($('#proyecto-actividades_indicadorbid_'+(valor[i].value)).val())=='0') || ($.trim($('#proyecto-actividades_pesos_'+(valor[i].value)).val())=='') || ($.trim($('#proyecto-actividades_unidad_medidas_'+(valor[i].value)).val())=='') || ($.trim($('#proyecto-actividades_metas_'+(valor[i].value)).val())==''))
            {
